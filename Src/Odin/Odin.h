...
extern BOOL DownloadSingleFile(ST_FTP_INFO stFtpInfo, LPCTSTR strHash, LPCTSTR strLocalPath, LPCTSTR strPassword = NULL, FP_DOWNLOAD_PROGRESS fpCallback = nullptr);
...
//	_in_opt		strPassword		: 비밀번호 여부
//	_in_opt		ProgressBar		: Progress Control에 대한 포인터
extern BOOL DownloadMultiFile(ST_FTP_INFO stFtpInfo, std::vector<CString> vecHash, LPCTSTR strLocalPath, LPCTSTR strPassword = NULL, FP_DOWNLOAD_PROGRESS fpCallback = nullptr);
